...
module.exports = __webpack_require__("5a6c");
...
"use strict";
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_v16_dist_index_js_ref_1_1_Retweet_vue_vue_type_style_index_0_id_5176bfd8_lang_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("d737");
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_v16_dist_index_js_ref_1_1_Retweet_vue_vue_type_style_index_0_id_5176bfd8_lang_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_mini_css_extract_plugin_dist_loader_js_ref_11_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_11_oneOf_1_1_node_modules_vue_loader_v16_dist_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_11_oneOf_1_2_node_modules_less_loader_dist_cjs_js_ref_11_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_1_0_node_modules_vue_loader_v16_dist_index_js_ref_1_1_Retweet_vue_vue_type_style_index_0_id_5176bfd8_lang_less__WEBPACK_IMPORTED_MODULE_0__);
...
function getTargetType(value) {
    return value["__v_skip" /* ReactiveFlags.SKIP */] || !Object.isExtensible(value)
        ...
        : targetTypeMap(Object(shared_esm_bundler["R" /* toRawType */])(value));
}
...
function createSuspenseBoundary(vnode, parent, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals, isHydrating = false) {
    ...
    const timeout = vnode.props ? Object(shared_esm_bundler["Q" /* toNumber */])(vnode.props.timeout) : undefined;
    if ((false)) {}
    const suspense = {
        vnode,
        parent,
...
function toHandlers(obj, preserveCaseIfNecessary) {
    ...
    for (const key in obj) {
        ret[preserveCaseIfNecessary && /[A-Z]/.test(key)
            ? `on:${key}`
            : Object(shared_esm_bundler["P" /* toHandlerKey */])(key)] = obj[key];
    }
    return ret;
}
        ...
        for (const key in raw) {
            ...
            if (validatePropName(normalizedKey)) {
                ...
                const prop = (normalized[normalizedKey] =
                    Object(shared_esm_bundler["o" /* isArray */])(opt) || Object(shared_esm_bundler["q" /* isFunction */])(opt) ? { type: opt } : Object.assign({}, opt));
                if (prop) {
            ...
            const doSet = () => {
                if (rawRef.f) {
                    const existing = _isString
                        ? Object(shared_esm_bundler["k" /* hasOwn */])(setupState, ref)
                            ? setupState[ref]
                            : refs[ref]
                        : ref.value;
                    if (isUnmount) {
                ...
                if (forcePatchValue ||
                    ...
                    for (const key in props) {
                        if ((forcePatchValue && key.endsWith('value')) ||
                            (Object(shared_esm_bundler["x" /* isOn */])(key) && !Object(shared_esm_bundler["B" /* isReservedProp */])(key))) {
...
function baseCreateRenderer(options, createHydrationFns) {
    ...
    target.__VUE__ = true;
    if (false) {}
    const { insert: hostInsert, remove: hostRemove, patchProp: hostPatchProp, createElement: hostCreateElement, createText: hostCreateText, createComment: hostCreateComment, setText: hostSetText, setElementText: hostSetElementText, parentNode: hostParentNode, nextSibling: hostNextSibling, setScopeId: hostSetScopeId = shared_esm_bundler["d" /* NOOP */], insertStaticContent: hostInsertStaticContent } = options;
...
const normalizeRef = ({ ref, ref_key, ref_for }) => {
    return (ref != null
        ? Object(shared_esm_bundler["F" /* isString */])(ref) || isRef(ref) || Object(shared_esm_bundler["q" /* isFunction */])(ref)
                ...
                for (const key in props) {
                    ...
                    if (opt === Number || (opt && opt.type === Number)) {
                        if (key in this._props) {
                            this._props[key] = Object(shared_esm_bundler["Q" /* toNumber */])(this._props[key]);
                        }
                        (numberProps || (numberProps = Object.create(null)))[Object(shared_esm_bundler["e" /* camelize */])(key)] = true;
                    }
                }
            }
    ...
    beforeUpdate(el, { value, modifiers: { lazy, trim, number } }, vnode) {
        ...
        if (document.activeElement === el && el.type !== 'range') {
            ...
            if ((number || el.type === 'number') &&
                Object(shared_esm_bundler["J" /* looseToNumber */])(el.value) === value) {
                return;
            }
        }
        const newValue = value == null ? '' : value;
    ...
    created(el, { value, modifiers: { number } }, vnode) {
        ...
        addEventListener(el, 'change', () => {
            const selectedVal = Array.prototype.filter
                ...
                .map((o) => number ? Object(shared_esm_bundler["J" /* looseToNumber */])(getValue(o)) : getValue(o));
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--14-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader??ref--14-2!./node_modules/vue-loader-v16/dist/templateLoader.js??ref--6!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader-v16/dist??ref--1-1!./src/view/Retweet.vue?vue&type=template&id=5176bfd8&ts=true

function Retweetvue_type_template_id_5176bfd8_ts_true_render(_ctx, _cache, $props, $setup, $data, $options) {
    var _component_TweetModal = resolveComponent("TweetModal");
    return (_ctx.isModalActive)
        ? (openBlock(), createBlock(_component_TweetModal, {
            key: 0,
            suggestions: _ctx.suggestions,
            onSuggestionSelected: _ctx.applySuggestion
        }, null, 8, ["suggestions", "onSuggestionSelected"]))
        : createCommentVNode("", true);
}

// CONCATENATED MODULE: ./src/view/Retweet.vue?vue&type=template&id=5176bfd8&ts=true

// EXTERNAL MODULE: ./src/utils/ContentScriptErrors.ts
var ContentScriptErrors = __webpack_require__("d86f");

// CONCATENATED MODULE: ./src/composables/tweetBoxes.ts

var tweetWrapperSelector = "div.r-18u37iz";
var tweetTextAreaSelector = "[data-text='true']";
var tweetActionsSelector = "div.css-1dbjc4n";
var IdCounter = 0;
var callback;
var detectTweets = function (callbackFn) {
    // Select the entire DOM for observing:
    var target = document.querySelector('body');
    // Create a new observer instance:
    var observer = new MutationObserver(function () {
        if (document.querySelector(tweetTextAreaSelector)) {
            console.log("tweet box detected");
            parseTweet();
        }
    });
...
var parseTweet = function () {
    var tweetsDom = document.querySelectorAll(tweetTextAreaSelector);
    for (var i = 0; i < tweetsDom.length; i++) {
        console.log(tweetsDom[i]);
        var tweetDom = tweetsDom[i].closest(tweetWrapperSelector);
        //filter matched div elements only
        if (!(tweetDom instanceof HTMLDivElement))
            continue;
        //prevent duplicate parsing
        if (tweetDom.getElementsByClassName('retweet-ai-handler')[0])
            continue;
        var div = generateActions(tweetDom);
        //append retweet ai actions at bottom of tweet box
        var tweetDefaultActions = tweetDom.querySelector(tweetActionsSelector);
        if (tweetDefaultActions) {
            tweetDefaultActions.append(div);
        }
    }
};
function generateActions(container) {
    var uniqueId = String(IdCounter++);
    //generating action div
    var div = document.createElement("div");
    div.classList.add("retweet-ai-handler", "idle-state", "action-container");
    div.dataset.id = uniqueId;
    div.dataset.parsing = "0";
    var serious = document.createElement("span");
    serious.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" style=\"width:20px\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" class=\"w-6 h-6\">\n    <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M7.5 8.25h9m-9 3H12m-9.75 1.51c0 1.6 1.123 2.994 2.707 3.227 1.129.166 2.27.293 3.423.379.35.026.67.21.865.501L12 21l2.755-4.133a1.14 1.14 0 01.865-.501 48.172 48.172 0 003.423-.379c1.584-.233 2.707-1.626 2.707-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0012 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018z\" />\n  </svg>\n  <span>Serious</span>";
    serious.classList.add("idle-element", "action-element");
    var joke = document.createElement("span");
    joke.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" style=\"width:20px\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" class=\"w-6 h-6\">\n    <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75zm-.375 0h.008v.015h-.008V9.75zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75zm-.375 0h.008v.015h-.008V9.75z\" />\n  </svg>\n  <span>Joke</span>";
    joke.classList.add("idle-element", "action-element");
    var question = document.createElement("span");
    question.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" style=\"width:20px\" class=\"w-6 h-6\">\n    <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z\" />\n  </svg>\n  <span>Question</span>";
    question.classList.add("idle-element", "action-element");
    var idea = document.createElement("span");
    idea.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" style=\"width:20px\" stroke=\"currentColor\" class=\"w-6 h-6\">\n                        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18\" />\n                    </svg>\n                    <span>Idea</span>";
    idea.classList.add("idle-element", "action-element");
    var loading = document.createElement("span");
    loading.innerHTML = "<svg xmlns=\"http://www.w3.org/2000/svg\" fill=\"none\" viewBox=\"0 0 24 24\" stroke-width=\"1.5\" stroke=\"currentColor\" style=\"width:20px\" class=\"w-6 h-6 rotate\">\n                        <path stroke-linecap=\"round\" stroke-linejoin=\"round\" d=\"M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99\" />\n                    </svg>\n                    <span style='margin-left:5px;'> Loading Suggestions </span>";
    loading.style.setProperty("color", "#00a79d");
    loading.classList.add("parsing-element");
    div.appendChild(serious);
    div.appendChild(joke);
    div.appendChild(question);
    div.appendChild(idea);
    div.appendChild(loading);
    [serious, joke, question, idea].forEach(function (action) { return action.addEventListener("click", function (event) {
        //event.stopPropagation()
        console.log("action selected = ", action.innerText);
        var tweetContainer = container.querySelector("[data-text='true']");
        var tweet = tweetContainer ? tweetContainer.textContent : "";
        //check if suggestion is being processed or if no tweet detected
        if (div.dataset.parsing === "1" || !tweet)
            return;
        try {
            div.dataset.parsing = "1";
            var element = event.target;
            var elementId = div.dataset.id;
            div.classList.remove("idle-state");
            div.classList.add("parsing-state");
            console.log(tweet);
            //emit show modal after receiving response
            chrome.runtime.sendMessage({
                "command": "find-suggestions",
                "tweet": tweet,
                "action": action.innerText,
                elementId: elementId
            }, function (response) {
                console.log("returned response", response);
                //show popup if no issues found
                if (retweetResponseHandler(response, div, tweet))
                    callback.call(null, action.innerText, tweet, tweetContainer, event, response);
            });
        }
        catch (err) {
            //failed to detect content
            //displayError(err instanceof Error ? err.message:String(err))
            retweetResponseHandler({ error: err instanceof Error ? err.message : String(err) }, div, tweet);
        }
    }); });
    return div;
}
function retweetResponseHandler(response, div, tweet) {
    var _a;
    div.classList.add("idle-state");
    div.classList.remove("parsing-state");
    div.dataset.parsing = "0";
    if (!response) {
        console.log("empty response", (_a = chrome.runtime.lastError) === null || _a === void 0 ? void 0 : _a.message);
        Object(ContentScriptErrors["a" /* displayError */])("Connection error", "Failed to parse tweet - " + tweet);
        return false;
    }
    if (response.error) {
        Object(ContentScriptErrors["a" /* displayError */])(response.error, "Failed to parse tweet - " + tweet);
        return false;
    }
    return true;
}

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--14-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader??ref--14-2!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader-v16/dist??ref--1-1!./src/components/TweetModal.vue?vue&type=script&setup=true&lang=ts


var _hoisted_1 = { class: "retweet-ai-modal-container" };
var _hoisted_2 = { class: "title" };
var _hoisted_3 = ["src"];
var _hoisted_4 = /*#__PURE__*/ createBaseVNode("p", { class: "title-text" }, "Retweet AI Suggestions", -1);
var _hoisted_5 = /*#__PURE__*/ createBaseVNode("hr", { class: "retweet-break-hr" }, null, -1);
var _hoisted_6 = { class: "retweet-ai-body" };
var _hoisted_7 = {
    key: 0,
    class: "retweet-ai-list"
};
var _hoisted_8 = ["onClick"];
var _hoisted_9 = {
    key: 1,
    class: "no-suggestions-found"
};
var _hoisted_10 = /*#__PURE__*/ createBaseVNode("p", null, "No suggestions found", -1);
var _hoisted_11 = [
    _hoisted_10
];
/* harmony default export */ var TweetModalvue_type_script_setup_true_lang_ts = (/*#__PURE__*/defineComponent({
    __name: 'TweetModal',
    props: {
        suggestions: {
            type: Array
    ...
    setup: function (__props, _a) {
        var emits = _a.emit;
        var props = __props;
        var logoSrc = chrome.runtime.getURL('./logo.png');
        var selectOption = function (selectedOption) {
            console.log(selectedOption);
            //emit selected option
            emits("suggestionSelected", selectedOption);
        };
        return function (_ctx, _cache) {
            ...
            return (openBlock(), createElementBlock("div", _hoisted_1, [
                ...
                createBaseVNode("div", _hoisted_6, [
                    ((_a = __props.suggestions) === null || _a === void 0 ? void 0 : _a.length)
                        ? (openBlock(), createElementBlock("div", _hoisted_7, [
                            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.suggestions, function (suggestion) {
                                return (openBlock(), createElementBlock("div", {
                                    class: "retweet-ai-item",
                                    key: suggestion
                                }, [
                                    createBaseVNode("div", {
                                        class: "suggestion-container",
                                        onClick: withModifiers(function ($event) { return (selectOption(suggestion)); }, ["stop"])
                                    }, Object(shared_esm_bundler["O" /* toDisplayString */])(suggestion), 9, _hoisted_8)
                                ]));
                            }), 128))
                        ]))
...
// CONCATENATED MODULE: ./src/components/TweetModal.vue?vue&type=script&setup=true&lang=ts
 
// CONCATENATED MODULE: ./src/components/TweetModal.vue



const __exports__ = TweetModalvue_type_script_setup_true_lang_ts;

/* harmony default export */ var TweetModal = (__exports__);
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--14-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/ts-loader??ref--14-2!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader-v16/dist??ref--1-1!./src/view/Retweet.vue?vue&type=script&lang=ts



var retweetWrapperDom;
/* harmony default export */ var Retweetvue_type_script_lang_ts = (defineComponent({
    setup: function () {
        var isModalActive = reactivity_esm_bundler_ref(false);
        var suggestions = reactivity_esm_bundler_ref();
        var activeTweetBox = reactivity_esm_bundler_ref();
        var activeSuggestionBox = reactivity_esm_bundler_ref();
        var displaySuggestions = function (action, tweet, tweetContainer, event, response) {
            console.log("performing action on tweet = ", action, tweet, response);
            //store current active tweet/suggestion box
            activeTweetBox.value = tweetContainer;
            suggestions.value = response.suggestions;
            retweetWrapperDom.style.setProperty("top", event.clientY + 50 + "px");
            retweetWrapperDom.style.setProperty("left", event.clientX + "px");
            isModalActive.value = true;
        };
        var applySuggestion = function (suggestion) {
            if (activeTweetBox.value) {
                activeTweetBox.value.textContent = suggestion;
                setTimeout(function () {
                    var _a;
                    ...
                    (_a = activeTweetBox.value) === null || _a === void 0 ? void 0 : _a.dispatchEvent(event);
                    setTimeout(function () {
                        var _a;
                        (_a = activeTweetBox.value) === null || _a === void 0 ? void 0 : _a.dispatchEvent(new Event('focus'));
        ...
        //set watchers
        watch(isModalActive, function (currentValue, oldValue) {
            if (currentValue)
                retweetWrapperDom.style.setProperty("display", "block");
            else
                retweetWrapperDom.style.setProperty("display", "none");
        });
        //detect tweetboxes and append actions
        onMounted(function () {
            retweetWrapperDom = document.getElementById("retweet-ai--wrapper");
            detectTweets(displaySuggestions);
        ...
        return { isModalActive: isModalActive, activeTweetBox: activeTweetBox, displaySuggestions: displaySuggestions, applySuggestion: applySuggestion, suggestions: suggestions };
    },
    components: { TweetModal: TweetModal }
}));

// CONCATENATED MODULE: ./src/view/Retweet.vue?vue&type=script&lang=ts
 
// EXTERNAL MODULE: ./src/view/Retweet.vue?vue&type=style&index=0&id=5176bfd8&lang=less
var Retweetvue_type_style_index_0_id_5176bfd8_lang_less = __webpack_require__("50fc");

// EXTERNAL MODULE: ./node_modules/vue-loader-v16/dist/exportHelper.js
var exportHelper = __webpack_require__("6b0d");
var exportHelper_default = /*#__PURE__*/__webpack_require__.n(exportHelper);

// CONCATENATED MODULE: ./src/view/Retweet.vue
...
const Retweet_exports_ = /*#__PURE__*/exportHelper_default()(Retweetvue_type_script_lang_ts, [['render',Retweetvue_type_template_id_5176bfd8_ts_true_render]])

/* harmony default export */ var Retweet = (Retweet_exports_);
// CONCATENATED MODULE: ./src/entry/content.ts


window.addEventListener('load', function () {
    //append app
    var retweetAIWrapper = document.createElement("div");
    retweetAIWrapper.id = "retweet-ai--wrapper";
    retweetAIWrapper.style.setProperty("display", "none");
    document.body.appendChild(retweetAIWrapper);
    var TweetsHandlerApp = runtime_dom_esm_bundler_createApp(Retweet).mount("#retweet-ai--wrapper");
    //append styles
    var contentStyle = document.createElement("link");
    contentStyle.type = "text/css";
    contentStyle.rel = "stylesheet";
    contentStyle.href = chrome.runtime.getURL('css/content.css');
    document.body.appendChild(contentStyle);
});
